...
router.get('/:invoiceId', [requireUser_1.default, (0, schema_middleware_1.default)(invoice_schema_1.getInvoiceSchema)], invoice_controller_1.getInvoiceController);
router.get('/', requireUser_1.default, invoice_controller_1.getInvoicesController);
