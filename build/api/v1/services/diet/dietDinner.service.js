...
exports.deleteDietDinner = exports.getAndUpdateDietDinner = exports.getDietDinnersWithTotal = exports.getDietDinners = exports.getDietDinner = exports.createDietDinner = void 0;
...
function getDietDinnersWithTotal(query, options = { lean: true }) {
    return __awaiter(this, void 0, void 0, function* () {
        const metricsLabels = {
            operation: 'getDietDinners',
        };
        const timer = metrics_1.databaseResponseTimeHistogram.startTimer();
        try {
            const result = yield dietDinner_model_1.default.find(query, {}, options).populate({
...
exports.getDietDinnersWithTotal = getDietDinnersWithTotal;
