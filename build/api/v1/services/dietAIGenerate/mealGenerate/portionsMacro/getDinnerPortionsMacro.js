...
const getMealDinnersPortionsMacro = (recommendDietDinner) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const dinnerProductsPortions = yield Promise.all(dinnerProducts.map(({ dinnerId, defaultAmount, portionsGram, productId, _id }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        return macroForPortions.map((macroPortion) => (Object.assign(Object.assign({}, macroPortion), { dinnerId,
            product, dinnerProductId: _id, dietDinnerId: recommendDietDinner._id })));
    })));
    const randomDinnerWithPortions = Object.assign(Object.assign({}, recommendDietDinner), { dinnerProductsPortions });
