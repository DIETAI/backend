...
const cartesianDinners = (dietEstablishment, mealEstablishment, currentProcent, ...portions) => {
    const result = [];
...
const cartesianGroupTotalCount = (groups) => {
    ...
    const total_fiber_gram = (0, exports.roundMacro)(countCartesianMacroTotal(groups, 'portionFiberGram'));
    const total_fiber_kcal = (0, exports.roundMacro)(countCartesianMacroTotal(groups, 'portionFiberKcal'));
    const total_digestableCarbohydrates_gram = (0, exports.roundMacro)(countCartesianMacroTotal(groups, 'portionDisgestibleCarbohydratesGram'));
    const total_digestableCarbohydrates_kcal = (0, exports.roundMacro)(countCartesianMacroTotal(groups, 'portionDisgestibleCarbohydratesKcal'));
    return {
        total_kcal,
        total_gram,
        total_protein_gram,
